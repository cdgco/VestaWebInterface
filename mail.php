...
<head>
    ...
    <title>Company Name - Mail Domains</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box"> <ul class="side-icon-text pull-right">
                                                        <li><a href="addmail.php"><span class="circle circle-sm bg-success di"><i class="ti-plus"></i></span><span>Add Domain</span></a></li>
                                                    </ul>
...
<button type="button" onclick="window.location=\'addmailaccount.php?domain=' . $mailname[$x1] . '\';" class="btn btn-info btn-outline btn-circle btn-md m-r-5" data-toggle="tooltip" data-original-title="Add Accounts"><i class="fa fa-plus"></i></button>
<button type="button" onclick="window.location=\'listmail.php?domain=' . $mailname[$x1] . '\';" class="btn btn-info btn-outline btn-circle btn-md m-r-5" data-toggle="tooltip" data-original-title="List Accounts"><i class="ti-menu-alt"></i></button>
<button type="button" onclick="window.location=\'editmail.php?domain=' . $mailname[$x1] . '\';" class="btn btn-info btn-outline btn-circle btn-md m-r-5" data-toggle="tooltip" data-original-title="Edit"><i class="ti-pencil-alt"></i></button>
<button onclick="confirmDelete(\'' . $mailname[$x1] . '\')" type="button" class="btn btn-info btn-outline btn-circle btn-md m-r-5" data-toggle="tooltip" data-original-title="Delete"><i class="icon-trash" ></i></button>
                                                                    ...
                                                                    <td>'; if($maildata[$x1][CATCHALL] != ''){ echo $maildata[$x1][CATCHALL];} else { echo "None";} echo '</td>
                                                                    <td>';                                                                   
