                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box"> <ul class="side-icon-text pull-right">
                                                        <li><a href="addbackup.php"><span class="circle circle-sm bg-inverse di"><i class="fa fa-calendar-check-o"></i></span><span>Schedule Backup</span></a></li>
...
<button onclick="window.location=\'configbackup.php?backup=' . $backupname[$x1] . '\';" type="button" data-toggle="tooltip" data-original-title="Configure" class="btn btn-info btn-outline btn-circle btn-md m-r-5"><i class="fa fa-cog"></i></button>
