...
else { header('Location: ../login.php?to=log/error.php' . $urlquery . $_SERVER['QUERY_STRING']); exit(); }

if(isset($webenabled) && $webenabled != 'true'){ header("Location: ../error-pages/403.html"); exit(); }

$v_domain = $_GET['domain'];

if ((!isset($v_domain)) || $v_domain == '') { header('Location: ../list/web.php'); exit(); }
...
<html lang="en">
    ...
    <head>
        ...
        <title><?php echo $sitetitle; ?> - <?php echo __("Error Log"); ?></title>
                ...
                <div class="container-fluid">
                    <div class="row bg-title" style="overflow:visible;">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 restwo">
                            <h4 class="page-title"><?php echo __("Error Log"); ?></h4> </div>
                        ...
                        <div>
                            <div class="white-box">
                                <ul class="side-icon-text pull-right resthree">
                                    <li><a style="cursor: pointer;" onclick="document.getElementById('accessform').submit();"><span class="circle circle-sm bg-success di" style="padding-top: 11px;"><i class="ti-download"></i></span><span><?php echo __("Download Accesslog"); ?></span></a></li>
                                    <li><a style="cursor: pointer;" onclick="document.getElementById('errorform').submit();"><span class="circle circle-sm bg-danger di" style="padding-top: 11px;"><i class="ti-download"></i></span><span><?php echo __("Download Errorlog"); ?></span></a></li>
                                </ul>
