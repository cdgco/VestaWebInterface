 ...
 *                       ***REMOVED***);
 *                     </script>
 *  options are passed as json (example: {mode: "popup", popClose: false***REMOVED***)
 *
 *  {OPTIONS***REMOVED***   | [type]     | (default), values      | Explanation
 *  ---------   | ---------  | ---------------------- | -----------
...
(function($) {
    var counter = 0;
    var modes = { iframe : "iframe", popup : "popup" ***REMOVED***;
    var standards = { strict : "strict", loose : "loose", html5 : "html5" ***REMOVED***;
        ...
        getPrintWindow : function () {
            switch ( settings.mode )
            {
                case modes.iframe :
                    ...
                    return { win : f.contentWindow || f, doc : f.doc ***REMOVED***;
                case modes.popup :
                    var p = new PrintArea.Popup();
                    return { win : p, doc : p.doc ***REMOVED***;
            ***REMOVED***
        ***REMOVED***,
        Iframe : function () {
            ...
            ***REMOVED***
            catch( e ) { throw e + ". iframes may not be supported in this browser."; ***REMOVED***
