                ...
                ***REMOVED***
                ...
                function r(e, t, i) {
                    ...
                    if (t && (o = parseInt(R.css("top")) + e * parseInt(s.wheelStep) / 100 * R.outerHeight(), o = Math.min(Math.max(o, 0), r), o = e > 0 ? Math.ceil(o) : Math.floor(o), R.css({
                            top: o + "px"
                        ***REMOVED***)), v = parseInt(R.css("top")) / (x.outerHeight() - R.outerHeight()), o = v * (x[0].scrollHeight - x.outerHeight()), i) {
                        o = e;
                ...
                if (x.parent().hasClass(s.wrapperClass)) {
                    ...
                    if (R = x.closest("." + s.barClass), E = x.closest("." + s.railClass), l(), e.isPlainObject(i)) {
                        ...
                        ***REMOVED***
                        ...
                        r(C, !1, !0)
                    ***REMOVED***
                ***REMOVED*** else if (!(e.isPlainObject(i) && "destroy" in i)) {
                    ...
                    ***REMOVED***);
                    ...
                    E.css(D), R.css(D), x.wrap(S), x.parent().append(R), x.parent().append(E), s.railDraggable && R.bind("mousedown", function(i) {
                        ...
                        ***REMOVED***), o.bind("mouseup.slimscroll", function(e) {
                            d = !1, c(), o.unbind(".slimscroll")
                        ***REMOVED***), !1
                    ***REMOVED***).bind("selectstart.slimscroll", function(e) {
                        return e.stopPropagation(), e.preventDefault(), !1
                    ***REMOVED***), E.hover(function() {
                        n()
                    ***REMOVED***, function() {
                        c()
                    ***REMOVED***), R.hover(function() {
                        u = !0
                    ***REMOVED***, function() {
                        u = !1
                    ***REMOVED***), x.hover(function() {
                        h = !0, n(), c()
                    ***REMOVED***, function() {
                        h = !1, c()
                    ***REMOVED***), x.bind("touchstart", function(e, t) {
                        e.originalEvent.touches.length && (g = e.originalEvent.touches[0].pageY)
                    ***REMOVED***), x.bind("touchmove", function(e) {
                        ...
                        ***REMOVED***
                    ***REMOVED***), l(), "bottom" === s.start ? (R.css({
                        top: x.outerHeight() - R.outerHeight()
                    ***REMOVED***), r(0, !0)) : "top" !== s.start && (r(e(s.start).position().top, null, !0), s.alwaysVisible || R.hide()), a(this)
                ***REMOVED***
            ***REMOVED***), this
        ***REMOVED***
    ***REMOVED***), e.fn.extend({
