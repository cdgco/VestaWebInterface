<?php
    ...
    if(isset($_POST['v_hour']) { $v_hour = $_POST['v_hour']; }
    if(isset($_POST['v_day']) { $v_month = $_POST['v_month']; }
    if(isset($_POST['v_month']) { $v_month = $_POST['v_month']; }
    if(isset($_POST['v_wday']) { $v_wday = $_POST['v_wday']; }
    if(isset($_POST['v_cmd']) { $v_cmd = $_POST['v_cmd']; }
    if(isset($_POST['v_job']) { $v_job = $_POST['v_job']; }
       
    if (!isset($v_min)) { header('Location: ../edit/cron.php?returncode=1&job=' . $v_job);}
