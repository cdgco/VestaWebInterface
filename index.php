...
<script>
	window.mySettings = {
	first_name: '***REMOVED*** echo $admindata[FNAME]; ***REMOVED***',
	last_name: '***REMOVED*** echo $admindata[LNAME]; ***REMOVED***',
	suspended: '***REMOVED*** echo $admindata[SUSPENDED]; ***REMOVED***',
	package: '***REMOVED*** echo $admindata[PACKAGE]; ***REMOVED***',
	language: '***REMOVED*** echo $admindata[LANGUAGE]; ***REMOVED***',
	uname: '***REMOVED*** echo $username; ***REMOVED***',
	email: '***REMOVED*** echo $admindata[CONTACT]; ***REMOVED***',
	created_at: ***REMOVED*** echo strtotime($admindata[DATE] . ' ' . $admindata[TIME]); ***REMOVED***,
	joined_at: '***REMOVED*** echo $admindata[DATE] . ' ' . $admindata[TIME]; ***REMOVED***',
