        ...
        <div id="page-wrapper">
           <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="post" action="../create/database.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                            <div class="input-group-addon">***REMOVED*** print_r($uname); ***REMOVED***_</div>
                                            <input type="text" class="form-control" name="v_dbuser" style="padding-left: 0.5%;">    
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 input-group" style="padding-left: 15px;">
                                        <input type="password" pattern=".{6,***REMOVED***" class="form-control form-control-line" name="password" id="password">                                    <span class="input-group-btn"> 
