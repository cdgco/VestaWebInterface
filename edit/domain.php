...
<body class="fix-header" onload="checkDiv();checkDiv2();">
    <!-- ============================================================== -->
    <!-- Preloader -->
    <!-- ============================================================== -->
    <div class="preloader">
                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control select6" name="language" id="select6">
                                            <?php
                                                    if($webstats[0] != '') {
                                                        $x6 = 0; 
                                ...
                                <div class="form-group" style="cursor: no-drop;">
                                    ...
                                    <div class="col-md-12" data-toggle="tooltip" data-placement="left" title="Coming Soon">
                                        <div class="checkbox checkbox-info">
                                            <input id="checkbox6" style="cursor: no-drop;" type="checkbox" <?php if($domaindata[0][FTP_USER] != '') {echo 'checked';} ?> disabled>
                                            <label for="checkbox6" style="cursor: no-drop;"> Enabled </label>
                                        </div>
                                    </div>
                                </div>
