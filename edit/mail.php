           ...
           <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">***REMOVED*** echo _("Edit Mail Domain"); ***REMOVED***</h4>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="sk-chat-widgets">
                                <div class="panel panel-themecolor">
                                    ...
                                    <div class="panel-body">
                                        <center>
                                            <h2>
                                                ***REMOVED*** if ($maildata[0]['SUSPENDED'] == 'no') {echo _("Active");***REMOVED*** else {echo _("Suspended");***REMOVED******REMOVED***
                                            </h2>
                                        </center>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" autocomplete="off" method="post" action="../change/mail.php">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">***REMOVED*** echo _("AntiSpam Support"); ***REMOVED***</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">***REMOVED*** echo _("AntiVirus Support"); ***REMOVED***</label>
                                    <div class="col-md-12">
                                        <div class="checkbox checkbox-info">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">***REMOVED*** echo _("DKIM Support"); ***REMOVED***</label>
                                    <div class="col-md-12">
                                        <div class="checkbox checkbox-info">
                                            <input id="checkbox7" type="checkbox" name="v_dkim" ***REMOVED*** if($maildata[0]['DKIM'] == 'no') {***REMOVED*** else {echo 'checked';***REMOVED*** ***REMOVED*** >
                                            <label for="checkbox7"> ***REMOVED*** echo _("Enabled"); ***REMOVED*** </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="email" class="col-md-12">***REMOVED*** echo _("Catchall Email"); ***REMOVED***</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button class="btn btn-success">***REMOVED*** echo _("Update Domain"); ***REMOVED***</button> &nbsp;
                                            <a href="../list/mail.php" style="color: inherit;text-decoration: inherit;"><button class="btn btn-muted" type="button">***REMOVED*** echo _("Back"); ***REMOVED***</button></a>
                                    </div>
                                </div>
                            </form>
                        </div>
