***REMOVED***
    ...
    if (isset($requestdns) && $requestdns != '' && isset($requestrecord) && $requestrecord != '') {***REMOVED***
    ...
    ***REMOVED*** 
    ...
    if ($recordnumber[$requestrecord] == '') { header('Location: ../list/dns.php'); ***REMOVED***
***REMOVED***
                            ...
                            <div class="sk-chat-widgets">
                                <div class="panel panel-themecolor">
                                    ...
                                    <div class="panel-body">
                                        <center>
                                            <h2>
                                                ***REMOVED*** $date=date_create($recorddata[$requestrecord][DATE] . ' ' . $recorddata[$requestrecord][TIME]); echo date_format($date,"F j, Y - g:i A"); ***REMOVED***
                                            </h2>
                                        </center>
                                    </div>
                                </div>
                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" value="<? print_r($recorddata[$requestrecord][VALUE]); ***REMOVED***" class="form-control form-control-line" name="email" id="email"> </div>
                                </div>
                                <div class="form-group">
                                    <label for="email" class="col-md-12">Priority</label>
                                    <div class="col-md-12">
                                        <input type="text" value="<? print_r($recorddata[$requestrecord][PRIORITY]); ***REMOVED***" class="form-control form-control-line" name="email" id="email"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" value="<? print_r($recorddata[$requestrecord][ID]); ***REMOVED***" class="form-control form-control-line" name="email" id="email"> 
                                        <small class="form-text text-muted">Optional</small>
                                    </div>
                                </div>
                                <div class="form-group">
