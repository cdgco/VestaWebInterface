                                    ...
                                    <div class="col-md-12">
                                         <label class="sr-only" for="inlineFormInputGroup">Username</label>
                                            <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                                ...
                                                <input type="text" class="form-control" style="padding-left: 0.5%;" value="***REMOVED*** $prefix = $uname . '_'; $str = $dbdata[0][DBUSER]; if (substr($str, 0, strlen($prefix)) == $prefix) { $str = substr($str, strlen($prefix));***REMOVED*** print_r($str); ***REMOVED***">
                                            </div>
                                    </div>
                                </div>
                                <div class="form-group">
