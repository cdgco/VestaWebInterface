...
session_start();
    ...
    if (isset($requestdb) && $requestdb != '') {***REMOVED***
           ...
           <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">***REMOVED*** echo _("Edit Database"); ***REMOVED***</h4>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="sk-chat-widgets">
                                <div class="panel panel-themecolor">
                                    <div class="panel-heading">
                                        <center>***REMOVED*** echo _("DATABASE"); ***REMOVED***</center>
                                    </div>
                                    <div class="panel-body">
                                      <center><h2>***REMOVED*** print_r($dbname[0]); ***REMOVED***</h2></center>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="sk-chat-widgets">
                                <div class="panel panel-themecolor">
                                    ...
                                    <div class="panel-body">
                                        <center>
                                            <h2>
                                                ***REMOVED*** $date=date_create($dbdata[0]['DATE'] . ' ' . $dbdata[0]['TIME']); echo date_format($date,"F j, Y - g:i A"); ***REMOVED***
                                            </h2>
                                        </center>
                                    </div>
                                </div>
                            ...
                            <div class="sk-chat-widgets">
                                <div class="panel panel-themecolor">
                                    ...
                                    <div class="panel-body">
                                        <center>
                                            <h2>
                                                ***REMOVED*** if ($dbdata[0]['SUSPENDED'] == 'no') {echo _("Active");***REMOVED*** else {echo _("Suspended");***REMOVED******REMOVED***
                                            </h2>
                                        </center>
                                    </div>
                                </div>
                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" autocomplete="off" method="post" action="../change/database.php">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" disabled value="<? print_r($dbname[0]); ***REMOVED***" style="background-color: #eee;padding-left: 0.6%;border-radius: 2px;border: 1px solid rgba(120, 130, 140, 0.13);bottom: 19px;background-image: none;"class="form-control uneditable-input form-control-static"> 
                                        <input type="hidden" name="v_database" value="<? print_r($dbname[0]); ***REMOVED***"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">***REMOVED*** echo _("User"); ***REMOVED***</label>
                                    <div class="col-md-12">
                                         <label class="sr-only" for="inlineFormInputGroup">***REMOVED*** echo _("Username"); ***REMOVED***/label>
                                            <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                                <div class="input-group-addon">***REMOVED*** print_r($uname); ***REMOVED***_</div>
                                                <input type="text" class="form-control" autocomplete="new-password" name="v_dbuser" style="padding-left: 0.5%;" value="***REMOVED*** $prefix = $uname . '_'; $str = $dbdata[0][DBUSER]; if (substr($str, 0, strlen($prefix)) == $prefix) { $str = substr($str, strlen($prefix));***REMOVED*** print_r($str); ***REMOVED***">
                                            </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">***REMOVED*** echo _("Host"); ***REMOVED***</label>
                                    <div class="col-md-12">
                                        <input type="text" disabled value="<? print_r($dbdata[0]['HOST']); ***REMOVED***" style="background-color: #eee;padding-left: 0.6%;border-radius: 2px;border: 1px solid rgba(120, 130, 140, 0.13);bottom: 19px;background-image: none;"class="form-control uneditable-input form-control-static"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">***REMOVED*** echo _("Type"); ***REMOVED***</label>
                                    <div class="col-md-12">
                                        <input type="text" disabled value="<? print_r($dbdata[0]['TYPE']); ***REMOVED***" style="background-color: #eee;padding-left: 0.6%;border-radius: 2px;border: 1px solid rgba(120, 130, 140, 0.13);bottom: 19px;background-image: none;"class="form-control uneditable-input form-control-static"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">***REMOVED*** echo _("Charset"); ***REMOVED***</label>
                                    <div class="col-md-12">
                                        <input type="text" disabled value="<? print_r($dbdata[0]['CHARSET']); ***REMOVED***" style="background-color: #eee;padding-left: 0.6%;border-radius: 2px;border: 1px solid rgba(120, 130, 140, 0.13);bottom: 19px;background-image: none;"class="form-control uneditable-input form-control-static"> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button class="btn btn-success">***REMOVED*** echo _("Update Database"); ***REMOVED***</button> &nbsp;
