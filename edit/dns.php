                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" value="<? print_r($dnsdata[0][IP]); ***REMOVED***" class="form-control form-control-line" name="email" id="email"> </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group date">
                                            <input type="text" class="form-control datepicker" value="***REMOVED*** echo date("m/d/Y", strtotime($dnsdata[0][EXP])); ***REMOVED***">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" value="<? print_r($dnsdata[0][SOA]); ***REMOVED***" class="form-control form-control-line" name="email" id="email"> </div>
                                </div>
                                <div class="form-group">
                                    <label for="email" class="col-md-12">TTL (Time To Live)</label>
                                    <div class="col-md-12">
                                        <input type="text" value="<? print_r($dnsdata[0][TTL]); ***REMOVED***" class="form-control form-control-line" name="email" id="email"> </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
