...
<![endif]-->
 ...
 <ul class="nav" id="side-menu">
                            ...
                            <?php if ($mailenabled == 'true') { echo '<li> <a href="../list/mail.php" class="active"><i class="fa fa-envelope fa-fw"></i><span class="hide-menu">Mail</span></a> </li>'; } ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box"> <ul class="side-icon-text pull-right">
                        <li><a href="../add/mailaccount.php?domain=<? echo $requestmail; ?>"><span class="circle circle-sm bg-success di"><i class="ti-plus"></i></span><span>Add Account</span></a></li>
                        </ul>
                                ...
                                if($mailname[0] != '') {
                                    ...
                                    do {
                                        ...
                                        <button type="button" onclick="confirmDelete(\'' . $mailname[$x1] . '\')" class="btn btn-info btn-outline btn-circle btn-md m-r-5" data-toggle="tooltip" data-original-title="Delete"><i class="icon-trash" ></i></button>
                                                                    ...
                                                                    <td>'; if(implode(', ', explode(",", $maildata[$x1]['ALIAS'])) == "") { echo "None";} else{ echo implode(', ', explode(",", $maildata[$x1]['ALIAS']));} echo '</td>
                                                                     <td>'; if($maildata[$x1]['FWD'] == ""){ echo '<span class="label label-table label-danger">Disabled</span>';} 
    ...
    function confirmDelete(e){
        ...
        swal({
            ...
            $.ajax({  
                ...
                success:  function(){ window.location = "maildomain.php?delcode=0&domain=" + e0; },
                error:  function(){ window.location = "maildomain.php?delcode=0&domain=" + e0; }
            });
        })}
