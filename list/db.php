...
else { header('Location: ../login.php?to=list/db.php' . $urlquery . $_SERVER['QUERY_STRING']); exit(); }
        ...
        <script type="text/javascript">
            ...
            function confirmSuspend(f){
                ...
                Swal.fire({
                  ...
                  window.location.replace("../admin/suspend/db.php?user=<?php echo $username; ?>&resource=" + f1);
                  }
                })}
            function confirmUnsuspend(f2){
                ...
                Swal.fire({
                  ...
                  window.location.replace("../admin/unsuspend/db.php?user=<?php echo $username; ?>&resource=" + f2);
                  }
                })}
            <?php
            processPlugins();
