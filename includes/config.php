...
DEFINE('SITE_NAME', 'CDG Host'); // Site name for use in page titles. Ex: 'My Host Company'.
DEFINE('THEME', 'default'); // Accepted options are 'default', 'blue', 'purple' and 'orange'

// VESTA API SETTINGS //
DEFINE('VESTA_HOST_ADDRESS', 'host.cdgtech.one'); // URL or IP Address of VestaCP. Ex: 'myhost.com' or '12.34.56.78'.
...
DEFINE('VESTA_ADMIN_PW', 'Carter09'); // Password for VestaCP Admin account. Ex: 'MyPassword1'.
...
DEFINE('PHPPGADMIN_URL', ''); // phpPgAdmin URL. Leave blank for VestaCP default. Set as 'disabled; to remove phpPgAdmin option.
DEFINE('SUPPORT_URL', ''); // Support URL. Leave blank or set to 'disabled' to disable.
