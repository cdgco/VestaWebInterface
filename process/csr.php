...
$postvars = array(
    ...
    array('hash' => $vst_apikey, 'user' => $vst_username,'password' => $vst_password,'cmd' => 'v-generate-ssl-cert','arg1' => $ssldomain,'arg2' => $sslemail, 'arg3' => $sslcountry,'arg4' => $sslstate,'arg5' => $sslcity,'arg6' => $sslorg,'arg7' => $sslunit,'arg8' => $sslalias,'arg9' => 'json'));
    ...
    <body class="fix-header">
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <script> 
                    function exitForm() { window.location.href="../edit/domain.php?domain=<?php echo $ssldomain; ?>"; };
                </script>
