...
***REMOVED***(function ($) {
  ...
  var createVideoNode = function (url) {
    ...
    var ytRegExp = /^(?:https?:\/\/)?(?:www\.)?(?:youtu\.be\/|youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))((\w|-){11***REMOVED***)(?:\S+)?$/;
    ...
    var vimRegExp = /\/\/(player.)?vimeo.com\/([a-z]*\/)*([0-9]{6,11***REMOVED***)[?]?.*/;
    ...
    ***REMOVED*** else if (igMatch && igMatch[0].length) {
      $video = $('<iframe>')
        .attr('frameborder', 0)
    ...
    ***REMOVED*** else if (vMatch && vMatch[0].length) {
      $video = $('<iframe>')
        .attr('frameborder', 0)
        .attr('src', vMatch[0] + '/embed/simple')
        .attr('width', '600').attr('height', '600')
        .attr('class', 'vine-embed');
    ***REMOVED*** else if (vimMatch && vimMatch[3].length) {
      $video = $('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
        .attr('frameborder', 0)
        .attr('src', '//player.vimeo.com/video/' + vimMatch[3])
        .attr('width', '640').attr('height', '360');
    ***REMOVED*** else if (dmMatch && dmMatch[2].length) {
      $video = $('<iframe>')
        .attr('frameborder', 0)
        .attr('src', '//www.dailymotion.com/embed/video/' + dmMatch[2])
        .attr('width', '640').attr('height', '360');
    ***REMOVED*** else if (youkuMatch && youkuMatch[1].length) {
      $video = $('<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>')
        .attr('frameborder', 0)
        .attr('height', '498')
        .attr('width', '510')
        .attr('src', '//player.youku.com/embed/' + youkuMatch[1]);
    ***REMOVED*** else if (mp4Match || oggMatch || webmMatch) {
  ...
  ***REMOVED***;
  ...
  $.summernote.addPlugin({
     ...
     * @property {function(object): string***REMOVED*** buttons.video
     */
    buttons: {
    ...
    ***REMOVED***,
    ...
    /**
     * @property {Object***REMOVED*** dialogs
     * @property {function(object, object): string***REMOVED*** dialogs.video
    */
    dialogs: {
      video: function (lang) {
    ...
    ***REMOVED***,
     ...
     * @property {Function***REMOVED*** events.showVideoDialog
     */
    events: {
