...
$("#jsGrid").jsGrid({
    ...
    fields: [
        { name: "Name", type: "text", width: 150 ***REMOVED***,
        { name: "Age", type: "number", width: 50 ***REMOVED***,
        { name: "Address", type: "text", width: 200 ***REMOVED***,
        { name: "Country", type: "select", items: db.countries, valueField: "Id", textField: "Name" ***REMOVED***,
        { name: "Married", type: "checkbox", title: "Is Married", sorting: false ***REMOVED***,
...

{
    ...
    ***REMOVED***,
    ...
    rowClass: function(item, itemIndex) { ... ***REMOVED***,
    rowClick: function(args) { ... ***REMOVED***,
    rowDoubleClick: function(args) { ... ***REMOVED***,
    ...
    invalidNotify: function(args) { ... ***REMOVED***
    ...
    loadShading: true,
    loadIndicator: function(config) { ... ***REMOVED***
    loadStrategy: function(config) { ... ***REMOVED***
...

{
    ...
    headerTemplate: function() { ... ***REMOVED***,
    itemTemplate: function(value, item) { ... ***REMOVED***,
    filterTemplate: function() { ... ***REMOVED***,
    insertTemplate: function() { ... ***REMOVED***,
    editTemplate: function(value, item) { ... ***REMOVED***,

    filterValue: function() { ... ***REMOVED***,
    insertValue: function() { ... ***REMOVED***,
    editValue: function() { ... ***REMOVED***,
...
- **sorter** is a string or a function specifying how to sort item by the field. The string is a key of sorting strategy in the registry `jsGrid.sortStrategies` (the registry can be easily extended with custom sorting functions). Sorting function has the signature `function(value1, value2) { return -1|0|1; ***REMOVED***`.
...
- **loadData** is a function returning an array of data or jQuery promise that will be resolved with an array of data (when `pageLoading` is `true` instead of object the structure `{ data: [items], itemsCount: [total items count] ***REMOVED***` should be returned). Accepts filter parameter including current filter options and paging parameters when `pageLoading` is `true`.
...
The default value is  `"Pages: {first***REMOVED*** {prev***REMOVED*** {pages***REMOVED*** {next***REMOVED*** {last***REMOVED*** &nbsp;&nbsp; {pageIndex***REMOVED*** of {pageCount***REMOVED***"`

There are placeholders that can be used in the format:

```javascript

{first***REMOVED***     // link to first page
{prev***REMOVED***      // link to previous page
{pages***REMOVED***     // page links
{next***REMOVED***      // link to next page
{last***REMOVED***      // link to last page
{pageIndex***REMOVED*** // current page index
{pageCount***REMOVED*** // total amount of pages
{itemCount***REMOVED*** // total amount of items
...

{
    ...
    errors              // array of validation violations in format { field: "fieldName", message: "validator message" ***REMOVED***
***REMOVED***
...
{
    text: { ... ***REMOVED***,      // simple text input
    number: { ... ***REMOVED***,    // number input
    select: { ... ***REMOVED***,    // select control
    checkbox: { ... ***REMOVED***,  // checkbox input
    textarea: { ... ***REMOVED***,  // textarea control (renders textarea for inserting and editing and text input for filtering)
    control: { ... ***REMOVED***    // control field with delete and editing buttons for data rows, search and add buttons for filter and inserting row
***REMOVED***
...
MyDateField.prototype = new jsGrid.Field({
    ...
    ***REMOVED***,
    ...
    insertTemplate: function(value) {
        return this._insertPicker = $("<input>").datepicker({ defaultDate: new Date() ***REMOVED***);
    ***REMOVED***,
...

{
    fields: [
      ...
      { type: "date", myCustomProperty: "bar" ***REMOVED***,
      ...
    ]
***REMOVED***
...
var grid = new jsGrid.Grid($("#grid"), { ... ***REMOVED***);
...
// insert item
$("#grid").jsGrid("insertItem", { Name: "John", Age: 25, Country: 2 ***REMOVED***).done(function() {
...
$("#grid").jsGrid("loadData", { Name: "John" ***REMOVED***).done(function() {
...
$("#grid").jsGrid("search", { Name: "John" ***REMOVED***).done(function() {
    console.log("filtering completed");
***REMOVED***);
...
**sortConfig** is the plain object of the following structure `{ field: (fieldIndex|fieldName|field), order: ("asc"|"desc") ***REMOVED***`
...
$("#grid").jsGrid("sort", { field: "Name", order: "desc" ***REMOVED***);
...
$("#grid").jsGrid("updateItem", { ID: 1, Name: "John", Age: 25, Country: 2 ***REMOVED***);

// update specified item with particular data (row DomNode or row jQueryElement can be used instead of item reference)
$("#grid").jsGrid("updateItem", item, { ID: 1, Name: "John", Age: 25, Country: 2 ***REMOVED***).done(function() {
...
{
    onDataLoading: function(args) {***REMOVED***,    // before controller.loadData
    onDataLoaded: function(args) {***REMOVED***,     // on done of controller.loadData
    onItemInserting: function(args) {***REMOVED***,  // before controller.insertItem
    onItemInserted: function(args) {***REMOVED***,   // on done of controller.insertItem
    onItemUpdating: function(args) {***REMOVED***,   // before controller.updateItem
    onItemUpdated: function(args) {***REMOVED***,    // on done of controller.updateItem
    onItemDeleting: function(args) {***REMOVED***,   // before controller.deleteItem
    onItemDeleted: function(args) {***REMOVED***,    // on done of controller.deleteItem
    onItemInvalid: function(args) {***REMOVED***,    // after item validation, in case data is invalid
    
    onError: function(args) {***REMOVED***,          // on fail of any controller call
    
    onOptionChanging: function(args) {***REMOVED***, // before changing the grid option
    onOptionChanged: function(args) {***REMOVED***,  // after changing the grid option
    
    onRefreshing: function(args) {***REMOVED***,     // before grid refresh
    onRefreshed: function(args) {***REMOVED***,      // after grid refresh
***REMOVED***
...
$("#grid").jsGrid({
    ...
    onItemInvalid: function(args) {
        // prints [{ field: "Name", message: "Enter client name" ***REMOVED***]
...
{
    loadData: function(filter) { ... ***REMOVED***,
    insertItem: function(item) { ... ***REMOVED***,
    updateItem: function(item) { ... ***REMOVED***,
    deleteItem: function(item) { ... ***REMOVED***
***REMOVED***
...
$("#grid").jsGrid({
    ...
    fields: [{ type: "text", name: "FieldName", validate: "required" ***REMOVED***]
***REMOVED***);
 ...
 * `Object` - validator configuration of structure `{ validator, message, param ***REMOVED***`
...
$("#grid").jsGrid({
    ...
    fields: [{ 
        ...
        validate: [
            "required",
            { validator: "range", param: [21, 80] ***REMOVED***,
            function(value, item) {
...
```javascript
    ...
    jsGrid.validators.time = {
        ...
        validator: function(value, item) {
            return /^([01]\d|2[0-3]|[0-9])(:[0-5]\d){1,2***REMOVED***$/.test(value);
        ***REMOVED***
    ***REMOVED***
...
{
    string: { ... ***REMOVED***,          // string sorter
    number: { ... ***REMOVED***,          // number sorter
    date: { ... ***REMOVED***,            // date sorter
    numberAsString: { ... ***REMOVED***   // numbers are parsed before comparison
***REMOVED***
...

{
    fields: [
      ...
      { type: "text", name: "Name", sorter: "client" ***REMOVED***,
      ...
    ]
***REMOVED***
...
```javascript
{
    firstDisplayIndex: function() {***REMOVED***,                        // returns the index of the first displayed item
    lastDisplayIndex: function() {***REMOVED***,                         // returns the index of the last displayed item
    itemsCount: function() {***REMOVED***,                               // returns the total amount of grid items
    
    openPage: function(index) {***REMOVED***,                            // handles opening of the particular page
    loadParams: function() {***REMOVED***,                               // returns additional parameters for controller.loadData method
    sort: function() {***REMOVED***,                                     // handles sorting of data in the grid
    
    finishLoad: function(loadedData) {***REMOVED***,                     // handles the finish of loading data by controller.loadData
    finishInsert: function(insertedItem) {***REMOVED***,                 // handles the finish of inserting item by controller.insertItem
    finishDelete: function(deletedItem, deletedItemIndex) {***REMOVED*** // handles the finish of deleting item by controller.deleteItem
***REMOVED***
```
...
- **loadParams** returns an object with the structure `{ pageIndex, pageSize ***REMOVED***` to provide server with paging info
...
```javascript
{
    show: function() { ... ***REMOVED*** // called on loading start
    hide: function() { ... ***REMOVED*** // called on loading finish
***REMOVED***
```
