...
describe "Dropzone", ->
  ...
  describe "Emitter", ->
    ...
    describe ".off()", ->
      ...
      it "should work without any listeners", ->
        ...
        emt = emitter.off()
        emitter._callbacks.should.eql {***REMOVED***
  ...
  describe "static functions", ->
    ...
    describe "Dropzone.isValidFile()", ->
      it "should return true if called without acceptedFiles", ->
        Dropzone.isValidFile({ type: "some/type" ***REMOVED***, null).should.be.ok

      it "should properly validate if called with concrete mime types", ->
        acceptedMimeTypes = "text/html,image/jpeg,application/json"

        Dropzone.isValidFile({ type: "text/html" ***REMOVED***, acceptedMimeTypes).should.be.ok
        Dropzone.isValidFile({ type: "image/jpeg" ***REMOVED***, acceptedMimeTypes).should.be.ok
        Dropzone.isValidFile({ type: "application/json" ***REMOVED***, acceptedMimeTypes).should.be.ok
        Dropzone.isValidFile({ type: "image/bmp" ***REMOVED***, acceptedMimeTypes).should.not.be.ok
      ...
      it "should properly validate if called with base mime types", ->
        ...
        Dropzone.isValidFile({ type: "image/jpeg" ***REMOVED***, acceptedMimeTypes).should.be.ok
        Dropzone.isValidFile({ type: "application/json" ***REMOVED***, acceptedMimeTypes).should.be.ok
        Dropzone.isValidFile({ type: "image/bmp" ***REMOVED***, acceptedMimeTypes).should.be.ok
        Dropzone.isValidFile({ type: "some/type" ***REMOVED***, acceptedMimeTypes).should.not.be.ok
      ...
      it "should properly validate extensions", ->
        ...
        Dropzone.isValidFile({ name: "somxsfsd", type: "text/html" ***REMOVED***, acceptedMimeTypes).should.be.ok
        Dropzone.isValidFile({ name: "somesdfsdf", type: "image/jpeg" ***REMOVED***, acceptedMimeTypes).should.be.ok
        Dropzone.isValidFile({ name: "somesdfadfadf", type: "application/json" ***REMOVED***, acceptedMimeTypes).should.not.be.ok
        Dropzone.isValidFile({ name: "some-file file.pdf", type: "random/type" ***REMOVED***, acceptedMimeTypes).should.be.ok
        # .pdf has to be in the end
        Dropzone.isValidFile({ name: "some-file.pdf file.gif", type: "random/type" ***REMOVED***, acceptedMimeTypes).should.not.be.ok
        Dropzone.isValidFile({ name: "some-file file.png", type: "random/type" ***REMOVED***, acceptedMimeTypes).should.be.ok
  ...
  describe "Dropzone.getElement() / getElements()", ->
    ...
    describe ".getElement()", ->
      ...
      it "should fail if invalid selector", ->
        ...
        expect(-> Dropzone.getElement { "lblasdlfsfl" ***REMOVED***, "clickable").to.throw errorMessage
        expect(-> Dropzone.getElement [ "lblasdlfsfl" ], "clickable").to.throw errorMessage
  ...
  describe "init()", ->
    describe "clickable", ->
      ...
      dropzones =
        "using acceptedFiles": new Dropzone(Dropzone.createElement("""<form action="/"></form>"""), { clickable: yes, acceptedFiles: "audio/*,video/*" ***REMOVED***)
        "using acceptedMimeTypes": new Dropzone(Dropzone.createElement("""<form action="/"></form>"""), { clickable: yes, acceptedMimeTypes: "audio/*,video/*" ***REMOVED***)
  ...
  describe "instance", ->
    ...
    describe ".accept()", ->
      ...
      it "should pass if the filesize is OK", ->
        dropzone.accept { size: 2 * 1024 * 1024, type: "audio/mp3" ***REMOVED***, (err) -> expect(err).to.be.undefined

      it "shouldn't pass if the filesize is too big", ->
        dropzone.accept { size: 10 * 1024 * 1024, type: "audio/mp3" ***REMOVED***, (err) -> err.should.eql "File is too big (10MiB). Max filesize: 4MiB."

      it "should properly accept files which mime types are listed in acceptedFiles", ->

        dropzone.accept { type: "audio/mp3" ***REMOVED***, (err) -> expect(err).to.be.undefined
        dropzone.accept { type: "image/png" ***REMOVED***, (err) -> expect(err).to.be.undefined
        dropzone.accept { type: "audio/wav" ***REMOVED***, (err) -> expect(err).to.be.undefined

      it "should properly reject files when the mime type isn't listed in acceptedFiles", ->
        dropzone.accept { type: "image/jpeg" ***REMOVED***, (err) -> err.should.eql "You can't upload files of this type."

      it "should fail if maxFiles has been exceeded and call the event maxfilesexceeded", ->
        sinon.stub dropzone, "getAcceptedFiles"
        file = { type: "audio/mp3" ***REMOVED***

        dropzone.getAcceptedFiles.returns { length: 99 ***REMOVED***

        dropzone.options.dictMaxFilesExceeded = "You can only upload {{maxFiles***REMOVED******REMOVED*** files."
        ...
        dropzone.getAcceptedFiles.returns { length: 100 ***REMOVED***
    ...
    describe "events", ->
      ...
      describe "progress updates", ->
        ...
        it "should properly emit a totaluploadprogress event", (done) ->
          ...
          dropzone.emit "uploadprogress", { ***REMOVED***
