    ...
    describe("Emitter", function() {
      ...
      ***REMOVED***);
      it(".on() should return the object itself", function() {
        return (emitter.on("test", function() {***REMOVED***)).should.equal(emitter);
      ***REMOVED***);
      ...
      ***REMOVED***);
      return describe(".off()", function() {
        ...
        callback1 = function() {***REMOVED***;
        callback2 = function() {***REMOVED***;
        callback3 = function() {***REMOVED***;
        callback4 = function() {***REMOVED***;
        beforeEach(function() {
      ...
      describe("Dropzone.forElement()", function() {
        ...
        ***REMOVED***);
        it("should throw an exception if no dropzone attached", function() {
          ...
          ***REMOVED***).to["throw"]("No Dropzone found for given element. This is probably because you're trying to access it before Dropzone had the time to initialize. Use the `init` option to setup any additional observers on your Dropzone.");
        ***REMOVED***);
        ...
        ***REMOVED***);
        it("should properly validate if called with concrete mime types", function() {
          ...
          Dropzone.isValidFile({
            type: "text/html"
          ***REMOVED***, acceptedMimeTypes).should.be.ok;
          Dropzone.isValidFile({
            type: "image/jpeg"
          ***REMOVED***, acceptedMimeTypes).should.be.ok;
          Dropzone.isValidFile({
          ...
          ***REMOVED***, acceptedMimeTypes).should.be.ok;
          return Dropzone.isValidFile({
            type: "image/bmp"
          ***REMOVED***, acceptedMimeTypes).should.not.be.ok;
        ***REMOVED***);
    ...
    describe("constructor()", function() {
      ...
      ***REMOVED***);
      it("should throw an exception if the element is invalid", function() {
        ...
        ***REMOVED***).to["throw"]("Invalid dropzone element.");
      ***REMOVED***);
        ...
        ***REMOVED***);
        return expect(function() {
          return new Dropzone(element, {
            url: "url"
          ***REMOVED***);
        ***REMOVED***).to["throw"]("Dropzone already attached.");
      ***REMOVED***);
      it("should throw an exception if both acceptedFiles and acceptedMimeTypes are specified", function() {
        ...
        return expect(function() {
          ...
          ***REMOVED***);
        ***REMOVED***).to["throw"]("You can't provide both 'acceptedFiles' and 'acceptedMimeTypes'. 'acceptedMimeTypes' is deprecated.");
      ***REMOVED***);
          ...
          ***REMOVED***);
          return it("should throw an exception if the element is invalid", function() {
            return expect(function() {
              ...
              ***REMOVED***);
            ***REMOVED***).to["throw"]("Invalid `clickable` option provided. Please provide a CSS selector, a plain HTML element or a list of those.");
          ***REMOVED***);
        ***REMOVED***);
      ***REMOVED***);
    ***REMOVED***);
      ...
      beforeEach(function() {
        ...
        ***REMOVED***;
        ...
        return dropzone = new Dropzone(element, {
          ...
          url: "url",
          acceptedMimeTypes: "audio/*,image/png",
          uploadprogress: function() {***REMOVED***
        ***REMOVED***);
      ***REMOVED***);
      afterEach(function() {
      ...
      ***REMOVED***);
      describe(".removeFile()", function() {
        return it("should abort uploading if file is currently being uploaded", function(done) {
          ...
          dropzone.uploadFile = function(file) {***REMOVED***;
        ...
        it("should be able to create instance of dropzone on the same element after destroy", function() {
          ...
          return (function() {
            return new Dropzone(element, {
              ...
              uploadprogress: function() {***REMOVED***
            ***REMOVED***);
          ***REMOVED***).should.not["throw"](Error);
        ***REMOVED***);
      ...
      ***REMOVED***);
      describe("getUploadingFiles()", function() {
        return it("should return all files with the status Dropzone.UPLOADING", function(done) {
          ...
          ***REMOVED***;
          dropzone.uploadFile = function() {***REMOVED***;
          dropzone.addFile(mock1);
          dropzone.addFile(mock2);
          dropzone.addFile(mock3);
          dropzone.addFile(mock4);
      ...
      ***REMOVED***);
      describe("addFile()", function() {
        it("should properly set the status of the file", function() {
          ...
          ***REMOVED***;
          dropzone.processFile = function() {***REMOVED***;
          dropzone.uploadFile = function() {***REMOVED***;
          dropzone.addFile(mockFile);
      ...
      describe("enqueueFile()", function() {
        ...
        ***REMOVED***);
        it("should fail if the file has already been processed", function() {
          ...
          ***REMOVED***)).to["throw"]("This file can't be queued because it has already been processed or was rejected.");
