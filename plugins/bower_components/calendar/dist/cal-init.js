    ...
    CalendarApp.prototype.init = function() {
        ...
        $this.$calendarObj = $this.$calendar.fullCalendar({
            ...
            ***REMOVED***,
            ...
            selectable: true,
            drop: function(date) { $this.onDrop($(this), date); ***REMOVED***,
            select: function (start, end, allDay) { $this.onSelect(start, end, allDay); ***REMOVED***,
            eventClick: function(calEvent, jsEvent, view) { $this.onEventClick(calEvent, jsEvent, view); ***REMOVED***
