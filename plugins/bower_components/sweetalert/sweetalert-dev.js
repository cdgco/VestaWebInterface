...
var _interopRequireWildcard = function (obj) { return obj && obj.__esModule ? obj : { 'default': obj ***REMOVED***; ***REMOVED***;
...
sweetAlert = swal = function () {
  ...
  ***REMOVED***
  ...
  var params = _extend$hexToRgb$isIE8$logStr$colorLuminance.extend({***REMOVED***, _defaultParams2['default']);
  ...
  switch (typeof customizations) {
    ...
    // Ex: swal({ title:"Hello", text: "Just testing", type: "info" ***REMOVED***);
    case 'object':
 ...
 * @param {Object***REMOVED*** userParams
 */
...
***REMOVED***,{"./modules/default-params":2,"./modules/handle-click":3,"./modules/handle-dom":4,"./modules/handle-key":5,"./modules/handle-swal-dom":6,"./modules/set-params":8,"./modules/utils":9***REMOVED***],2:[function(require,module,exports){
'use strict';
  ...
  ***REMOVED***
  ...
  switch (e.type) {
    ...
    case 'click':
      ...
      ***REMOVED*** else if (doneFunctionExists && modalIsVisible || targetedOverlay) {
        handleCancel(modal, params);
      ***REMOVED*** else if (_hasClass$isDescendant.isDescendant(modal, target) && target.tagName === 'BUTTON') {
        sweetAlert.close();
      ***REMOVED***
      break;
  ***REMOVED***
...
***REMOVED***,{"./handle-dom":4,"./handle-swal-dom":6,"./utils":9***REMOVED***],4:[function(require,module,exports){
'use strict';
...
var fireClick = function fireClick(node) {
  ...
  ***REMOVED*** else if (document.createEvent) {
    // Fallback
  ...
  ***REMOVED*** else if (typeof node.onclick === 'function') {
    node.onclick();
  ***REMOVED***
***REMOVED***;
...
var stopEventPropagation = function stopEventPropagation(e) {
  ...
  if (typeof e.stopPropagation === 'function') {
    e.stopPropagation();
    e.preventDefault();
  ***REMOVED*** else if (window.event && window.event.hasOwnProperty('cancelBubble')) {
...
var handleKeyDown = function handleKeyDown(event, params, modal) {
  ...
  ***REMOVED*** else {
    if (keyCode === 13) {
      ...
      ***REMOVED***
    ***REMOVED*** else if (keyCode === 27 && params.allowEscapeKey === true) {
...
***REMOVED***,{"./handle-dom":4,"./handle-swal-dom":6***REMOVED***],6:[function(require,module,exports){
'use strict';
...
***REMOVED***,{"./default-params":2,"./handle-dom":4,"./injected-html":7,"./utils":9***REMOVED***],7:[function(require,module,exports){
"use strict";
...
var setParameters = function setParameters(params) {
  ...
  ***REMOVED*** else if (typeof params.animation === 'string') {
...
***REMOVED***,{"./handle-dom":4,"./handle-swal-dom":6,"./utils":9***REMOVED***],9:[function(require,module,exports){
'use strict';
...
var hexToRgb = function hexToRgb(hex) {
  var result = /^#?([a-f\d]{2***REMOVED***)([a-f\d]{2***REMOVED***)([a-f\d]{2***REMOVED***)$/i.exec(hex);
