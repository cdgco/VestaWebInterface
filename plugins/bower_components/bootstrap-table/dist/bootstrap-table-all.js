...
!function ($) {
    ...
    BootstrapTable.prototype.initTable = function () {
        ...
        ***REMOVED***);
        ...
        $.each(this.options.columns, function (i, column) {
            that.options.columns[i] = $.extend({***REMOVED***, BootstrapTable.COLUMN_DEFAULTS,
                {field: i***REMOVED***, column); // when field is undefined, use index instead
        ***REMOVED***);
        ...
        if (this.options.search) {
            ...
            $search.off('keyup drop').on('keyup drop', function (event) {
                ...
                timeoutId = setTimeout(function () {
                    that.onSearch(event);
                ***REMOVED***, that.options.searchTimeOut);
            ***REMOVED***);
        ...
        ***REMOVED***
        ...
        if (this.options.totalRows) {
            if (this.options.pageSize === this.options.formatAllRows()) {
                ...
                $allSelected = true;
            ***REMOVED*** else if (this.options.pageSize === this.options.totalRows) {
    ...
    ***REMOVED***;
    ...
    BootstrapTable.prototype.initServer = function (silent, query) {
        ...
        ***REMOVED***
        request = $.extend({***REMOVED***, calculateObjectValue(null, this.options.ajaxOptions), {
    ...
    ***REMOVED***;
    ...
    BootstrapTable.prototype.fitHeader = function () {
        ...
        ***REMOVED***).find('table').css('width', this.$el.css('width'))
    ...
    BootstrapTable.prototype.fitFooter = function () {
        ...
        ***REMOVED***
        ...
        this.$tableFooter.css({
            'margin-right': scrollWidth
        ***REMOVED***).find('table').css('width', elWidth)
    ...
    ***REMOVED***;
    ...
    BootstrapTable.prototype.load = function (data) {
        ...
        if (this.options.sidePagination === 'server') {
            ...
            data = data.rows;
        ***REMOVED*** else if (!$.isArray(data)) { // support fixedScroll
            fixedScroll = data.fixedScroll;
            data = data.data;
        ***REMOVED***
        ...
        for (i = len - 1; i >= 0; i--) {
            ...
            ***REMOVED***
            ...
            if (typeof row[uniqueId] === 'string') {
                id = id.toString();
            ***REMOVED*** else if (typeof row[uniqueId] === 'number') {
                if ((Number(row[uniqueId]) === row[uniqueId]) && (row[uniqueId] % 1 === 0)) {
                    id = parseInt(id);
                ***REMOVED*** else if ((row[uniqueId] === Number(row[uniqueId])) && (row[uniqueId] !== 0)) {
                    id = parseFloat(id);
                ***REMOVED***
            ***REMOVED***
    ...
    ***REMOVED***;
    ...
    BootstrapTable.prototype.filterBy = function (columns) {
        this.filterColumns = $.isEmptyObject(columns) ? {***REMOVED*** : columns;
        this.options.pageNumber = 1;
        this.initSearch();
        this.updatePagination();
    ***REMOVED***;
    ...
    $.fn.bootstrapTable = function (option) {
        ...
        this.each(function () {
            var $this = $(this),
                ...
                options = $.extend({***REMOVED***, BootstrapTable.DEFAULTS, $this.data(),
            ...
            if (!$export.length) {
                ...
                ***REMOVED***);
                ...
                $menu.find('li').click(function () {
                    that.$el.tableExport($.extend({***REMOVED***, that.options.exportOptions, {
                        type: $(this).data('type'),
                        escape: false
                    ***REMOVED***));
                ***REMOVED***);
...
!function ($) {
    ...
    ***REMOVED***;
    ...
    BootstrapTable.prototype.onColumnSearch = function (event) {
        ...
        if ($.isEmptyObject(this.filterColumnsPartial)) {
            this.filterColumnsPartial = {***REMOVED***;
        ***REMOVED***
        if (text) {
    ...
    ***REMOVED***;
    ...
    var changeView = function (that, width, height) {
        if (that.options.minHeight) {
            ...
            ***REMOVED*** else if (checkValuesGreater(width, that.options.minWidth) && checkValuesGreater(height, that.options.minHeight)) {
                conditionFullView(that);
            ***REMOVED***
        ***REMOVED*** else {
            if (checkValuesLessEqual(width, that.options.minWidth)) {
                conditionCardView(that);
            ***REMOVED*** else if (checkValuesGreater(width, that.options.minWidth)) {
                conditionFullView(that);
            ***REMOVED***
        ***REMOVED***
...
(function ($) {
    ...
    var initResizable = function (that) {
        ...
        that.$el.colResizable({disable: true***REMOVED***);
    ...
    ***REMOVED***);
    ...
    BootstrapTable.prototype.toggleView = function () {
        ...
        if (this.options.resizable && this.options.cardView) {
            //Deletes the plugin
            $(this.$el).colResizable({disable: true***REMOVED***);
        ***REMOVED***
    ***REMOVED***;
    ...
    BootstrapTable.prototype.load = function(data) {
        ...
        ***REMOVED*** else {
            if (!firstLoad) {
                ...
                height += 10;
                $("#" + this.options.idTable).bootstrapTable("resetView", {height: height***REMOVED***);
                firstLoad = true;
            ***REMOVED***
        ***REMOVED***
    ***REMOVED***;
