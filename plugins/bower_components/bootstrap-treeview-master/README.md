...
$('#tree').treeview({data: getTree()***REMOVED***);
```
...
```javascript
$('#tree').treeview('checkAll', { silent: true ***REMOVED***);
```
...
```javascript
$('#tree').treeview('checkNode', [ nodeId, { silent: true ***REMOVED*** ]);
```
...
```javascript
$('#tree').treeview('collapseAll', { silent: true ***REMOVED***);
```
...
Collapse a given tree node and it's child nodes.  If you don't want to collapse the child nodes, pass option `{ ignoreChildren: true ***REMOVED***`.

```javascript
$('#tree').treeview('collapseNode', [ nodeId, { silent: true, ignoreChildren: false ***REMOVED*** ]);
```
...
```javascript
$('#tree').treeview('disableAll', { silent: true ***REMOVED***);
```
...
```javascript
$('#tree').treeview('disableNode', [ nodeId, { silent: true ***REMOVED*** ]);
```
...
```javascript
$('#tree').treeview('enableAll', { silent: true ***REMOVED***);
```
...
```javascript
$('#tree').treeview('enableNode', [ nodeId, { silent: true ***REMOVED*** ]);
```
...
```javascript
$('#tree').treeview('expandAll', { levels: 2, silent: true ***REMOVED***);
```
...
```javascript
$('#tree').treeview('expandNode', [ nodeId, { levels: 2, silent: true ***REMOVED*** ]);
```
...
```javascript
$('#tree').treeview('revealNode', [ nodeId, { silent: true ***REMOVED*** ]);
```
...
```javascript
$('#tree').treeview('selectNode', [ nodeId, { silent: true ***REMOVED*** ]);
```
...
```javascript
$('#tree').treeview('toggleNodeChecked', [ nodeId, { silent: true ***REMOVED*** ]);
```
...
```javascript
$('#tree').treeview('toggleNodeDisabled', [ nodeId, { silent: true ***REMOVED*** ]);
```
...
```javascript
$('#tree').treeview('toggleNodeExpanded', [ nodeId, { silent: true ***REMOVED*** ]);
```
...
```javascript
$('#tree').treeview('toggleNodeSelected', [ nodeId, { silent: true ***REMOVED*** ]);
```
...
```javascript
$('#tree').treeview('uncheckAll', { silent: true ***REMOVED***);
```
...
```javascript
$('#tree').treeview('uncheckNode', [ nodeId, { silent: true ***REMOVED*** ]);
```
...
```javascript
$('#tree').treeview('unselectNode', [ nodeId, { silent: true ***REMOVED*** ]);
```
