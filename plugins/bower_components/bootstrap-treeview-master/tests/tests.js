...
;(function () {
	...
	***REMOVED***
	...
	test('Options setup', function () {
		...
		var opts = {
			...
			showTags: true,
			multiSelect: true,
			onNodeChecked: function () {***REMOVED***,
			onNodeCollapsed: function () {***REMOVED***,
			onNodeDisabled: function () {***REMOVED***,
			onNodeEnabled: function () {***REMOVED***,
			onNodeExpanded: function () {***REMOVED***,
			onNodeSelected: function () {***REMOVED***,
			onNodeUnchecked: function () {***REMOVED***,
			onNodeUnselected: function () {***REMOVED***,
			onSearchComplete: function () {***REMOVED***,
			onSearchCleared: function () {***REMOVED***
		***REMOVED***;
	...
	***REMOVED***);
	...
	test('Links enabled', function () {
		init({enableLinks:true, data:data***REMOVED***);
	...
	***REMOVED***);
	...
	test('Accepts JSON', function () {
		var el = init({levels:1,data:json***REMOVED***);
	...
	***REMOVED***);
	...
	test('Clicking a non-selectable, collapsed node expands the node', function () {
		var testData = $.extend(true, {***REMOVED***, data);
	...
	***REMOVED***);
	...
	test('getNode', function () {
		var $tree = init({ data: data ***REMOVED***);
	...
	***REMOVED***);
	...
	test('getChecked', function () {
		var $tree = init({ data: data, showCheckbox: true ***REMOVED***)
	...
	***REMOVED***);
	...
	test('disableAll / enableAll', function () {
		var $tree = init({ data: data, levels: 1 ***REMOVED***);
	...
	***REMOVED***);
	...
	test('checkAll / uncheckAll', function () {
		var $tree = init({ data: data, levels: 3, showCheckbox: true ***REMOVED***);
	...
	***REMOVED***);
	...
	test('selectNode / unselectNode', function () {
		var $tree = init({ data: data, selectedIcon: 'glyphicon glyphicon-selected' ***REMOVED***);
		var nodeId = 0;
		var node = $tree.treeview('getNode', 0);
	...
	***REMOVED***);
	...
	test('expandAll / collapseAll', function () {
		...
		$tree.treeview('expandAll', { levels: 1 ***REMOVED***);
	...
	***REMOVED***);
	...
	test('expandNode / collapseNode / toggleExpanded', function () {
		...
		$tree.treeview('expandNode', [ nodeParent1, { levels: 2 ***REMOVED*** ]);
	...
	***REMOVED***);
	...
	test('search', function () {
		...
		***REMOVED***);
		...
		var result = $tree.treeview('search', [ 'Parent 1', { ignoreCase: false, exactMatch: true ***REMOVED*** ]);
		equal(result.length, 1, 'Search "Parent 1" case sensitive, exact match - returns 1 result');

		// Case sensitive, like
		result = $tree.treeview('search', [ 'Parent', { ignoreCase: false, exactMatch: false ***REMOVED*** ]);
		equal(result.length, 5, 'Search "Parent" case sensitive, exact match - returns 5 results');

		// Case insensitive, exact match
		result = $tree.treeview('search', [ 'parent 1', { ignoreCase: true, exactMatch: true ***REMOVED*** ]);
		equal(result.length, 1, 'Search "parent 1" case insensitive, exact match - returns 1 result');

		// Case insensitive, like
		result = $tree.treeview('search', [ 'parent', { ignoreCase: true, exactMatch: false ***REMOVED*** ]);
	...
	***REMOVED***);
	...
	test('clearSearch', function () {
		...
		***REMOVED***);
		...
		$tree.treeview('search', [ 'Parent 1', { ignoreCase: false, exactMatch: true ***REMOVED*** ]);
