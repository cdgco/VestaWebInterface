		...
		***REMOVED***,
		compress: {
			main: {
				...
				***REMOVED***,
				files: [
					{expand: true, cwd: 'dist/', src: ['*'], dest: 'tablesaw/'***REMOVED***,
					{expand: true, cwd: 'dist/', src: ['dependencies/*'], dest: 'tablesaw/'***REMOVED***,
					{expand: true, cwd: 'dist/', src: ['stackonly/*'], dest: 'tablesaw/'***REMOVED***,
					{expand: true, cwd: 'dist/', src: ['bare/*'], dest: 'tablesaw/'***REMOVED***
				]
			***REMOVED***
		***REMOVED***
	***REMOVED***);
