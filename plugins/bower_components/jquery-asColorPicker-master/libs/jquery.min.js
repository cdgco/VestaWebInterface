	...
	toggleClass: function( value, stateVal ) {
		...
		***REMOVED***
		...
		return this.each(function() {
			...
			***REMOVED*** else if ( type === core_strundefined || type === "boolean" ) {
				if ( this.className ) {
	...
	attr: function( elem, name, value ) {
		...
		***REMOVED***
		...
		if ( value !== undefined ) {
			...
			***REMOVED*** else if ( hooks && notxml && "set" in hooks && (ret = hooks.set( elem, value, name )) !== undefined ) {
				return ret;
		...
		***REMOVED*** else if ( hooks && notxml && "get" in hooks && (ret = hooks.get( elem, name )) !== null ) {
			return ret;
...
var i,
	...
	***REMOVED***,
	...
	runescape = /\\([\da-fA-F]{1,6***REMOVED***[\x20\t\r\n\f]?|.)/g,
 ...
 * @param {Function***REMOVED*** fn The function to test for native support
 */
	...
	***REMOVED***
	...
	if ( !documentIsXML && !seed ) {
		...
		if ( (match = rquickExpr.exec( selector )) ) {
			...
			***REMOVED*** else if ( (m = match[3]) && support.getByClassName && context.getElementsByClassName ) {
...
function fixCloneNodeIssues( src, dest ) {
	...
	***REMOVED*** else if ( nodeName === "input" && manipulation_rcheckableType.test( src.type ) ) {
				...
				if ( data ) {
					...
					***REMOVED***
					...
					if ( cache[ id ] ) {
						...
						***REMOVED*** else if ( typeof elem.removeAttribute !== core_strundefined ) {
