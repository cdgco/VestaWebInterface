...
#     el: $('#donut-container'),
#     data: [
#       { label: 'yin',  value: 50 ***REMOVED***,
#       { label: 'yang', value: 50 ***REMOVED***
#     ]
#   ***REMOVED***);
class Morris.Donut extends Morris.EventEmitter
  ...
  constructor: (options) ->
    ...
    @options = $.extend {***REMOVED***, @defaults, options
  ...
  setLabels: (label1, label2) ->
    ...
    @text1.attr(transform: "S#{text1scale***REMOVED***,#{text1scale***REMOVED***,#{text1bbox.x + text1bbox.width / 2***REMOVED***,#{text1bbox.y + text1bbox.height***REMOVED***")
    @text2.attr(text: label2, transform: '')
    text2bbox = @text2.getBBox()
    text2scale = Math.min(maxWidth / text2bbox.width, maxHeightBottom / text2bbox.height)
    @text2.attr(transform: "S#{text2scale***REMOVED***,#{text2scale***REMOVED***,#{text2bbox.x + text2bbox.width / 2***REMOVED***,#{text2bbox.y***REMOVED***")
...
class Morris.DonutSegment extends Morris.EventEmitter
  ...
  calcSegment: (r1, r2) ->
    ...
    return (
      "M#{ix0***REMOVED***,#{iy0***REMOVED***" +
      "A#{r1***REMOVED***,#{r1***REMOVED***,0,#{@is_long***REMOVED***,0,#{ix1***REMOVED***,#{iy1***REMOVED***" +
      "L#{ox1***REMOVED***,#{oy1***REMOVED***" +
      "A#{r2***REMOVED***,#{r2***REMOVED***,0,#{@is_long***REMOVED***,1,#{ox0***REMOVED***,#{oy0***REMOVED***" +
      "Z")
  ...
  calcArc: (r) ->
    ...
    return (
      "M#{ix0***REMOVED***,#{iy0***REMOVED***" +
      "A#{r***REMOVED***,#{r***REMOVED***,0,#{@is_long***REMOVED***,0,#{ix1***REMOVED***,#{iy1***REMOVED***")
