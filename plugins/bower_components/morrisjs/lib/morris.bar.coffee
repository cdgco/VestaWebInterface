class Morris.Bar extends Morris.Grid
  constructor: (options) ->
    ...
    super($.extend {***REMOVED***, options, parseTime: false)
  ...
  colorFor: (row, sidx, type) ->
    if typeof @options.barColors is 'function'
      r = { x: row.x, y: row.y[sidx], label: row.label ***REMOVED***
      s = { index: sidx, key: @options.ykeys[sidx], label: @options.labels[sidx] ***REMOVED***
