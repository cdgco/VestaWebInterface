...
{
    throws(function() { $("#contentModeWithEmptyStringArgument").steps(); ***REMOVED***, /The enum key/, "Empty string argument");
    throws(function() { $("#contentModeWithWrongNumberArgument").steps(); ***REMOVED***, /Invalid enum value/, "Invalid number argument");
    throws(function() { $("#contentModeWithWrongStringArgument").steps(); ***REMOVED***, /The enum key/, "Invalid string argument");
...
test("stepCache", 4, function ()
{
    ...
    addStepToCache(wizard, $.extend({***REMOVED***, stepModel, { title: "add" ***REMOVED***));
    equal(steps.length, 1, "Valid count after add step to cache!");

    insertStepToCache(wizard, 0, $.extend({***REMOVED***, stepModel, { title: "insert" ***REMOVED***));
...
test("uniqueId", 5, function ()
{
    ...
    wizard.steps("add", { title: "add" ***REMOVED***);
