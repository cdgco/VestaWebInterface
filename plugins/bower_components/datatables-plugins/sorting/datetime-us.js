 ...
 *    $('#example').dataTable( {
 *       columnDefs: [
 *         { type: 'datetime-us', targets: 0 ***REMOVED***
 *       ]
 *    ***REMOVED*** );
*/
jQuery.extend(jQuery.fn.dataTableExt.oSort, {
    "datetime-us-pre": function (a) {
        var b = a.match(/(\d{1,2***REMOVED***)\/(\d{1,2***REMOVED***)\/(\d{2,4***REMOVED***) (\d{1,2***REMOVED***):(\d{1,2***REMOVED***) (am|pm|AM|PM|Am|Pm)/),
            month = b[1],
            day = b[2],
            year = b[3],
            hour = b[4],
...
jQuery.fn.dataTableExt.aTypes.unshift(
    function (sData) {
        if (sData !== null && sData.match(/\d{1,2***REMOVED***\/\d{1,2***REMOVED***\/\d{2,4***REMOVED*** \d{1,2***REMOVED***:\d{1,2***REMOVED*** (am|pm|AM|PM|Am|Pm)/)) {
