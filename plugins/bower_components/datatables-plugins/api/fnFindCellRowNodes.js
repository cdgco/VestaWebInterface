 ...
 *
 *  @param {string***REMOVED*** sSearch Data to search for
 *  @param {integer***REMOVED*** [iColumn=null] Limit search to this column
 *  @returns {array***REMOVED*** Array of `dt-tag tr` element with this data
 *
 *  @example
