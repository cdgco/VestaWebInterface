 ...
 *  @deprecated
 *
 *  @param {integer***REMOVED*** iMatch Column data index to convert to visible index
 *  @returns {integer***REMOVED*** Visible column index
 *
 *  @example
 *    var table = $('#example').dataTable( {
 *      aoColumnDefs: [
 *        { bVisible: false, aTargets: [1] ***REMOVED***
 *      ]
 *    ***REMOVED*** );
 *
 *    // This will show 1
