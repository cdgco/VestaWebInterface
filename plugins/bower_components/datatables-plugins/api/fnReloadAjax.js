 ...
 *  @deprecated
 *
 *  @param {string***REMOVED*** [sNewSource] URL to get the data from. If not give, the
 *    previously used URL is used.
 *  @param {function***REMOVED*** [fnCallback] Callback that is executed when the table has
 *    redrawn with the new data
 *  @param {boolean***REMOVED*** [bStandingRedraw=false] Standing redraw (don't changing the
 *      paging)
 *
 *  @example
