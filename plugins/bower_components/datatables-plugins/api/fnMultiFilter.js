 ...
 *  @deprecated
 *
 *  @param {object***REMOVED*** oData Data to search for
 *
 *  @example
 *    $(document).ready(function() {
 *        var table = $('#example').dataTable( {
 *            "aoColumns": [
 *                { "sName": "engine" ***REMOVED***,
 *                { "sName": "browser" ***REMOVED***,
 *                { "sName": "platform" ***REMOVED***,
 *                { "sName": "version" ***REMOVED***,
 *                { "sName": "grade" ***REMOVED***
 *            ]
 *        ***REMOVED*** );
 *        table.fnMultiFilter( { "engine": "Gecko", "browser": "Cam" ***REMOVED*** );
 *    ***REMOVED*** );
 */
