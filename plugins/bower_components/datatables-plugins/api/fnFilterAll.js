 ...
 *  @deprecated
 *
 *  @param {string***REMOVED*** sInput Filtering input
 *  @param {integer***REMOVED*** [iColumn=null] Column to apply the filter to
 *  @param {boolean***REMOVED*** [bRegex] Regular expression flag
 *  @param {boolean***REMOVED*** [bSmart] Smart filtering flag
 *
 *  @example
