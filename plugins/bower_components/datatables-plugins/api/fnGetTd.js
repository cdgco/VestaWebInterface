 ...
 *  @deprecated
 *
 *  @param {node***REMOVED*** mTr `dt-tag tr` element to get the `dt-tag td` of
 *  @param {integer***REMOVED*** iTd Column index to get the node of
 *  @param {boolean***REMOVED*** bVisOnly Consider visible columns only
 *  @returns {node***REMOVED*** `dt-tag td` element in question
 *
 *  @example
