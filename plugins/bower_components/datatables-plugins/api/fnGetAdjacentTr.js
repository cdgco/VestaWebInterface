 ...
 *
 *  @param {node***REMOVED*** nTr `dt-tag tr` element to get the adjacent element of
 *  @param {boolean***REMOVED*** [bNext=true] Get the next (`true`), or previous (`false`)
 *    `dt-tag tr` element.
 *  @returns {node***REMOVED*** `dt-tag tr` element or null if not found.
 *
 *  @example
