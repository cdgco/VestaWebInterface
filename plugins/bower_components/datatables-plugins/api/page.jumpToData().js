 ...
 *
 *  @param {****REMOVED*** data Data to search for
 *  @param {integer***REMOVED*** column Column index
 *  @returns {Api***REMOVED*** DataTables API instance
 *
 *  @example
...
jQuery.fn.dataTable.Api.register( 'page.jumpToData()', function ( data, column ) {
	var pos = this.column(column, {order:'current'***REMOVED***).data().indexOf( data );
