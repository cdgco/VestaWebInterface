  ...
  grunt.initConfig({
    ...
    ***REMOVED***,
    ...
    exec: {
      ...
      git_commit: {
        cmd: function(m) { return f('git commit -m "%s"', m); ***REMOVED***
      ***REMOVED***,
      git_tag: {
        cmd: function(v) { return f('git tag v%s -am "%s"', v, v); ***REMOVED***
      ***REMOVED***,
      publish_assets: [
    ...
    ***REMOVED***,
    ...
    connect: {
      server: {
        options: { port: 8888, keepalive: true ***REMOVED***
      ***REMOVED***
    ***REMOVED***,

    concurrent: {
      options: { logConcurrentOutput: true ***REMOVED***,
      dev: ['server', 'watch']
    ***REMOVED***,
