                        ...
                        <div class="panel">
                            <div class="sk-chat-widgets">
                                <div class="panel panel-themecolor">
                                    ...
                                    <div class="panel-body">
   <center><h2><?php print_r($admindata[U_DNS_RECORDS]); ?></h2></center>
                                </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box"> <ul class="side-icon-text pull-right">
                                                        <li><a href="adddns.php"><span class="circle circle-sm bg-success di"><i class="ti-plus"></i></span><span>Add Domain</span></a></li>
                                                    </ul>
...
<button onclick="window.location=\'adddnsrecord.php?domain=' . $dnsname[$x1] . '\';" type="button" data-toggle="tooltip" data-original-title="Add Records" class="btn btn-info btn-outline btn-circle btn-md m-r-5"><i class="fa fa-plus"></i></button>

<button onclick="window.location=\'listdns.php?domain=' . $dnsname[$x1] . '\';" type="button" data-toggle="tooltip" data-original-title="List Records" class="btn btn-info btn-outline btn-circle btn-md m-r-5"><i class="ti-menu-alt"></i></button>

<button type="button" onclick="window.location=\'editdns.php?domain=' . $dnsname[$x1] . '\';" data-toggle="tooltip" data-original-title="Edit" class="btn btn-info btn-outline btn-circle btn-md m-r-5"><i class="ti-pencil-alt"></i></button>
