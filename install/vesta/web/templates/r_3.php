...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" sizes="16x16" href="https://cdn.jsdelivr.net/gh/cdgco/VestaWebInterface@v0.5.5-Beta/plugins/images/favicon.png">
        ...
        <link href="https://cdn.jsdelivr.net/gh/cdgco/VestaWebInterface@v0.5.5-Beta/css/colors/default.css" id="theme"  rel="stylesheet">
        <!--[if lt IE 9]>
    ...
    <body>
        ...
        <script src="https://cdn.jsdelivr.net/gh/cdgco/VestaWebInterface@v0.5.5-Beta/js/main.js"></script>
        <script>
