...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" sizes="16x16" href="https://cdn.jsdelivr.net/gh/cdgco/VestaWebInterface@v1.0.0/plugins/images/favicon.png">
        ...
        <link href="https://cdn.jsdelivr.net/gh/cdgco/VestaWebInterface@v1.0.0/css/colors/default.css" id="theme"  rel="stylesheet">
        <!--[if lt IE 9]>
    ...
    <body>
        ...
        <script src="https://cdn.jsdelivr.net/gh/cdgco/VestaWebInterface@v1.0.0/js/main.js"></script>
        <script>
