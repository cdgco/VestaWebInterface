                    ...
                    <center style="width:80%;">
                        ...
                        <table style="width:80%; line-height: 200%;position:relative;left:12%;">
                            ...
                            <tr>
                                ...
                                <td style="font-size:16px;"><span style="color:<?php if (extension_loaded('openssl')) {echo "limegreen";  $a3 = 0; } else { echo "red";  $a3 = 1; } ?>"><?php if (extension_loaded('openssl')) {echo "Installed"; } else { echo "Not Installed"; } ?></span></td> 
                            </tr>
                            <tr>
                                <td style="font-size:16px;">PHP MySQLi Extension:</td>
                                <td style="font-size:16px;"><span style="color:<?php if (extension_loaded('mysqli')) {echo "limegreen";  $a4 = 0; } else { echo "red";  $a4 = 1; }  ?>"><?php if (extension_loaded('mysqli')) {echo "Installed"; } else { echo "Not Installed"; } ?></span></td> 
                            </tr>
                            <tr>
                                <td style="font-size:16px;">PHP FTP Extension:</td>
                                <td style="font-size:16px;"><span style="color:<?php if (extension_loaded('ftp')) {echo "limegreen";  $a5 = 0; } else { echo "red";  $a5 = 1; } ?>"><?php if (extension_loaded('ftp')) {echo "Installed"; } else { echo "Not Installed"; } ?></span></td> 
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="font-size:16px;"><span style="color:<?php if (file_exists( '../includes/config.php') === false) {echo "limegreen";  $a8 = 0; } else { echo "red";  $a8 = 1; } ?>"><?php if (file_exists( '../includes/config.php') === false) {echo "Does Not Exist";} else { echo "Exists";} ?></span></td> 
                            </tr>
                            <tr>
                                <td style="font-size:16px;">'includes' Is Writable (777):</td>
                                <td style="font-size:16px;"><span style="color:<?php if (substr(sprintf("%o",fileperms("../includes")),-3) == "777") {echo "limegreen";  $a9 = 0; } else { echo "red";  $a9 = 1; } ?>"><?php if (substr(sprintf("%o",fileperms("../includes")),-3) == "777") {echo "Writable";} else { echo "Not Writable";} ?></span></td> 
                            </tr>
                            <tr>
                                <td style="font-size:16px;">'tmp' Is Writable (777):</td>
                                <td style="font-size:16px;"><span style="color:<?php if (substr(sprintf("%o",fileperms("../tmp")),-3) == "777") {echo "limegreen";  $a10 = 0; } else { echo "red";  $a10 = 1; } ?>"><?php if (substr(sprintf("%o",fileperms("../tmp")),-3) == "777") {echo "Writable";} else { echo "Not Writable";} ?></span></td> 
                            </tr>
                            <tr>
                                <td style="font-size:16px;">'plugins/images/uploads' Is Writable (777):</td>
                                <td style="font-size:16px;"><span style="color:<?php if (substr(sprintf("%o",fileperms("../plugins/images/uploads")),-3) == "777") {echo "limegreen";  $a11 = 0; } else { echo "red";  $a11 = 1; } ?>"><?php if (substr(sprintf("%o",fileperms("../plugins/images/uploads")),-3) == "777") {echo "Writable";} else { echo "Not Writable";} ?></span></td> 
                            </tr>           
                        </table>
                        <br><br><br>
