           ...
           <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title"><?php echo _("Add User"); ?></h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" autocomplete="off" method="post" action="../create/firewall.php">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                            <input type="text" name="username" autocomplete="new-password" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                            <input type="email" name="email" autocomplete="new-password" class="form-control form-control-line">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                            <input type="text" name="fname" autocomplete="new-password" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12"><?php echo _("Last Name"); ?></label>
                                    <div class="col-md-12">
                                            <input type="text" name="lname" autocomplete="new-password" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button class="btn btn-success" onclick="processLoader();"><?php echo _("Add User"); ?></button> &nbsp;
