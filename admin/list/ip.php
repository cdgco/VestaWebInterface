...
else { header('Location: ../../login.php?to=admin/list/ip.php'.$urlquery.$_SERVER['QUERY_STRING']); exit(); }
    ...
    <body class="fix-header">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="white-box"> <ul class="side-icon-text pull-right">
                                <li><a href="../add/ip.php"><span class="circle circle-sm bg-success di"><i class="ti-plus"></i></span><span class="resfour"><wrapper class="resthree"><?php echo __("Add IP") ?> </wrapper><?php echo __("Address"); ?></span></a></li>
                                </ul>
                                <h3 class="box-title m-b-0"><?php echo __("IPs"); ?></h3><br>
                                <div class="table-responsive">
                                <table class="table footable m-b-0" data-paging-size="10" data-paging="false" data-sorting="true">
                                    <thead>
                                        <tr>
                                            <th data-sortable="false"> <?php echo __("Address"); ?> </th>
                                            <th data-toggle="true" data-type="numeric"> <?php echo __("Domains"); ?> </th>
                                            ...
                                            <th data-breakpoints="all"> <?php echo __("Netmask"); ?> </th>
                                            <th data-breakpoints="all"> <?php echo __("Interface"); ?> </th>
                                            <th data-breakpoints="all"> <?php echo __("Users"); ?> </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                            ...
                                            do {
                                                echo '<tr>
                                                    ...
                                                    <td class="resone" data-sort-value="' . $ipdata[$x1]['DATE'] . '">' . $ipdata[$x1]['DATE'] . '</td><td>
                                                        <a href="../edit/ip.php?ip=' . $ipname[$x1] . '"><button type="button" data-toggle="tooltip" data-original-title="' . __("Edit") . '" class="btn color-button btn-outline btn-circle btn-md m-r-5"><i class="ti-pencil-alt"></i></button></a><button onclick="confirmDelete(\'' . $ipname[$x1] . '\')" type="button" data-toggle="tooltip" data-original-title="' . __("Delete") . '" class="btn color-button btn-outline btn-circle btn-md m-r-5"><i class="fa fa-trash-o"></i></button>
                                                    </td>
        ...
        <script type="text/javascript">
            ...
            function confirmDelete(e){
                e1 = String(e)
                Swal.fire({
                  title: '<?php echo __("Delete IP Address"); ?>:<br>' + e1 +' ?',
