...
else { header('Location: ../../login.php?to=admin/list/fail2ban.php'.$urlquery.$_SERVER['QUERY_STRING']); exit(); }
...
$postvars = array(
    ...
    array('hash' => $vst_apikey, 'user' => $vst_username,'password' => $vst_password,'cmd' => 'v-list-firewall-ban','arg1' => 'json'));
    ...
    <body class="fix-header">
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <script> 
                    function addNewObj() { window.location.href="../add/fail2ban.php"; };
                </script>
