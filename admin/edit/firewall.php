...
$postvars = array(
    ...
    array('user' => $vst_username,'password' => $vst_password,'cmd' => 'v-list-firewall-rule','arg1' => $_GET['rule'],'arg2' => 'json')
);
                        ...
                        <div class="col-lg-12">
                            <div class="white-box">
                                <form class="form-horizontal form-material" autocomplete="off" method="post" action="../change/firewall.php">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success" onclick="processLoader();"><?php echo _("Update Rule"); ?></button> &nbsp;
