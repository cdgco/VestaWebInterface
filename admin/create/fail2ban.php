...
if ((!isset($_POST['v_chain'])) || ($_POST['v_chain'] == '')) { header('Location: ../add/fail2ban.php?error=1'); exit();}
elseif ((!isset($_POST['v_ip'])) || ($_POST['v_ip'] == '')) { header('Location: ../add/fail2ban.php?error=1'); exit();}
