...
else { header('Location: ../../login.php?to=admin/status/network.php'); exit(); }
...
$postvars = array(
    ...
    array('hash' => $vst_apikey, 'user' => $vst_username,'password' => $vst_password,'cmd' => 'v-list-sys-network-status'));
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                            ...
                            <div style="margin-right:257px;width:220px;" class="btn-group bootstrap-select input-group-btn" onclick="changeAction();">
                                <form id="statusform" method="post">
                                    <select class="selectpicker pull-right m-l-20" id="statuschange" data-style="form-control">';
                                        ...
                                        <option value="network" selected><?php echo __("Network"); ?></option>
                    ...
                    <div class="row">
                        <div>
                            <div class="white-box">
                                <h3 class="box-title m-b-0 restwo"><?php echo __("Network"); ?></h3>
