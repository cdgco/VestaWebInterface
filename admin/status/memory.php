...
else { header('Location: ../../login.php?to=admin/status/memory.php'); exit(); }
...
$postvars = array(
    ...
    array('hash' => $vst_apikey, 'user' => $vst_username,'password' => $vst_password,'cmd' => 'v-list-sys-memory-status'));
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                            ...
                            <div style="margin-right:257px;width:220px;" class="btn-group bootstrap-select input-group-btn" onclick="changeAction();">
                                <form id="statusform" method="post">
                                    <select class="selectpicker pull-right m-l-20" id="statuschange" data-style="form-control">';
                                        ...
                                        <option value="memory" selected><?php echo __("Memory"); ?></option>
                    ...
                    <div class="row">
                        <div>
                            <div class="white-box">
                                <h3 class="box-title m-b-0 restwo"><?php echo __("Memory"); ?></h3>
