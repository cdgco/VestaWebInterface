...
else { header('Location: ../../login.php?to=admin/status/dns.php'); exit(); }
...
$postvars = array(
    ...
    array('hash' => $vst_apikey, 'user' => $vst_username,'password' => $vst_password,'cmd' => 'v-list-sys-dns-status'));
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div>
                            <div class="white-box">
                                <h3 class="box-title m-b-0 restwo"><?php echo __("DNS"); ?></h3>
