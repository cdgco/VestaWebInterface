...
if ((!isset($_GET['user'])) || ($_GET['user'] == '')) { header('Location: ../list/users.php?error=1'); exit();}

$postvars = array('hash' => $vst_apikey, 'user' => $vst_username,'password' => $vst_password,'returncode' => 'yes','cmd' => 'v-unsuspend-user','arg1' => $v_user, 'arg2' => 'no');
