...
if ((!isset($_GET['rule'])) || ($_GET['rule'] == '')) { header('Location: ../list/firewall.php?error=1'); exit();}

$postvars = array('hash' => $vst_apikey, 'user' => $vst_username,'password' => $vst_password,'returncode' => 'yes','cmd' => 'v-unsuspend-firewall-rule','arg1' => $v_rule);
