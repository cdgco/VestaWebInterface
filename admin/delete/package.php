...
if ((!isset($_GET['package'])) || ($_GET['package'] == '')) { header('Location: ../list/packages.php?error=1'); exit();}

$postvars = array('hash' => $vst_apikey, 'user' => $vst_username,'password' => $vst_password,'returncode' => 'yes','cmd' => 'v-delete-user-package','arg1' => $v_package);
